"""Principal component analysis utilities for Chapter 3 workflows.

Pedagogical simplification:
- Focuses on covariance PCA with z-score standardization.
- Omits robust estimators and regime-aware covariance models.
"""
...
def run_pca(yield_matrix: np.ndarray, n_components: int | None = None) -> PCAResult:
    """Run PCA over standardized observations (rows=time, cols=features)."""
...
def factor_neutral_weights(
    ...
    """Construct minimum-norm weights neutral to selected factors."""
