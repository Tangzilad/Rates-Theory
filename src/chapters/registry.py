...
CHAPTER_DEPENDENCIES: dict[str, dict[str, list[str]]] = {
    ...
    "8": {"7": ["approved"]},
    "9": {
        "8": ["curve_fit_residual_bp", "residual_zscore", "screen_signal"],
        "3": ["candidate_neutral_hedge_weights"],
        "5": ["fair_price_under_shock", "modified_duration", "dv01"],
        "2": ["current_z_score", "half_life", "first_passage_probability"],
    },
    "10": {"9": ["preferred_hedge", "trade_direction", "conviction"]},
    "11": {"10": ["funding_basis_bp"]},
    "12": {"11": ["fallback_spread_bp"]},
    "13": {"12": ["asset_swap_spread_bp"]},
