...
CHAPTER_DEPENDENCIES: dict[str, dict[str, list[str]]] = {
    ...
    "5": {"4": ["z_score", "expected_path"]},
    "6": {"5": ["fair_price_under_shock", "slope"]},
    "7": {"1": ["fair_value", "residual", "direction"]},
    "8": {"6": ["zero_curve", "fit_params", "residual_diagnostics"]},
    "9": {"8": ["scenario_value"]},
    "10": {"9": ["scenario_value"]},
    "11": {"10": ["funding_basis_bp", "adjusted_fair_spread_bp"]},
