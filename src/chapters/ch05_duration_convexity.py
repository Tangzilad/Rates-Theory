...
class Chapter05(ChapterBase):
    ...
    def interactive_lab(self) -> RiskMetricState:
        ...
        slope, dp_pct, fair_price = shock_adjusted_bond_state(y2=y2, y10=y10, duration=duration, convexity=convexity, price=price, dy_bp=dy_bp)
        ...
        return RiskMetricState(curve_slope_bp=slope, duration=duration, convexity=convexity, dy_bp=dy_bp, dp_pct=dp_pct, fair_price=fair_price)
    ...
    def exports_to_next_chapter(self) -> ChapterExportState:
        return ChapterExportState(signals=["fair_price", "curve_slope_bp", "dp_pct"], usage="Compared with market pricing for rich/cheap screens.", schema_name="RiskMetricState")
