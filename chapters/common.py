...
class SimpleChapter(ChapterBase):
    ...
    def interactive_lab(self) -> Dict[str, Any]:
        ...
        scenario = base + shock_bp * sensitivity
        st.metric("Scenario output", f"{scenario:.3f}")
        return {"inputs": {"shock_bp": shock_bp, "base": base, "sensitivity": sensitivity}, "outputs": {"scenario_value": scenario}}
    ...
    def exports_to_next_chapter(self) -> Dict[str, Any]:
        return {"signals": ["scenario_value"], "usage": "Forwarded into downstream diagnostics."}
